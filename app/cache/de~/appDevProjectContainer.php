...
class appDevProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'jms_royal', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_43864195d8aca70dafb33443afac193e758b0465975602ffd35c5614154878d6');
    ...
    {
        return $this->services['prestashop.adapter.memcache_server.manager'] = new \PrestaShop\PrestaShop\Adapter\Cache\MemcacheServerManager($this->get('doctrine.dbal.default_connection'), 'jms_');
    }
    ...
    {
        return $this->services['prestashop.module.manager'] = new \PrestaShop\PrestaShop\Core\Addon\Module\ModuleManager($this->get('prestashop.core.admin.data_provider.module_interface'), $this->get('prestashop.adapter.data_provider.module'), $this->get('prestashop.core.module.updater'), $this->get('prestashop.core.admin.module.repository'), $this->get('prestashop.module.zip.manager'), $this->get('translator'), $this->get('event_dispatcher'), $this->get("prestashop.adapter.legacy.context")->getContext()->employee);
    }
    ...
    {
        return $this->services['prestashop.module.zip.manager'] = new \PrestaShop\PrestaShop\Adapter\Module\ModuleZipManager($this->get('filesystem'), $this->get('translator'), $this->get('event_dispatcher'));
    }
    ...
    {
        return $this->services['prestashop.module_kernel.repository'] = new \PrestaShopBundle\Kernel\ModuleRepository($this->get('doctrine.dbal.default_connection'), 'jms_');
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c = new \Symfony\Component\HttpKernel\DataCollector\ConfigDataCollector('PrestaShop', $this->get("prestashop.adapter.legacy.configuration")->get("_PS_VERSION_"));
        $c->setKernel($b);
    ...
    {
        return $this->services['translator'] = new \PrestaShopBundle\Translation\DataCollectorTranslator($this->get('translator.default'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('qmae0XgjaiOaeXOu5ozGzcvwFXLBBLCIDhVIq3IVuJBciB9mOBcu85f3');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5ac71dc8810007.49172188')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.active_modules' => array(
                ...
                63 => 'jmsblog',
                64 => 'jmsblogwidget',
                65 => 'jmscustomhtmlleft',
                66 => 'jmsfacebookconnect',
                67 => 'jmspagebuilder',
            ...
            'secret' => 'qmae0XgjaiOaeXOu5ozGzcvwFXLBBLCIDhVIq3IVuJBciB9mOBcu85f3',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2018-03-19',
            'locale' => 'en-US',
            'cookie_key' => '8qQwVr1Y43KqtAGELKUaHyH6awoVdxS0909I3G3AEhHBvj6ykci28Xmh',
            'cookie_iv' => 'hLQUN7yr',
            'new_cookie_key' => 'def0000047a03258a2ce497c8a7993a93ef3069f8dfee9d70b0579b4d20649a98622b7bc7c486ae5528dff25aaaf54ad1be0990982de00edf2465cf24473268dc81b654f',
            ...
            'kernel.secret' => 'qmae0XgjaiOaeXOu5ozGzcvwFXLBBLCIDhVIq3IVuJBciB9mOBcu85f3',
