					...
					<?php if ($_smarty_tpl->tpl_vars['show_time']->value=='1') {?>
						<li>
								<span class="post-created">
									...
									<?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['post']->value['created'],'html','UTF-8'),'%e %b, %Y'), ENT_QUOTES, 'UTF-8');?>
