...
class JmsBlog extends Module
{
    ...
    public function install()
    {
        ...
        if (parent::install() && $this->registerHook('moduleRoutes')) {
			...
			$res &= Configuration::updateValue('JMSBLOG_POST_LAYOUT', 'post-layout-default.tpl');
			$res &= Configuration::updateValue('JMSBLOG_CATEGORY_LAYOUT', 'category-layout-default.tpl');
			$res &= Configuration::updateValue('JMSBLOG_CATEGORIES_LAYOUT', 'categories-layout-defaut.tpl');
    ...
    public function uninstall()
    {
        ...
        if (parent::uninstall()) {
			...
			$res &= Configuration::deleteByName('JMSBLOG_POST_LAYOUT');
			$res &= Configuration::deleteByName('JMSBLOG_CATEGORY_LAYOUT');
			$res &= Configuration::deleteByName('JMSBLOG_CATEGORIES_LAYOUT');
