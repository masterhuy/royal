...
<div class="jms-tab">
	...
	{$cf = 0}
		{if $config.show_featured eq '1'}
			<li class="nav-item"><a class="button active" data-toggle="tab" href="#featured"><h3>{l s='Featured'  d='Shop.Theme'}</h3></a></li>
			<i class="fa fa-star-o"></i>
		{$cf = $cf + 1}
		{/if}
		
		{if $config.show_new eq '1'}
			<li class="nav-item"><a class="{if $cf eq 0}active{/if} button" data-toggle="tab" href="#latest"><h3>{l s='Latest'  d='Shop.Theme'}</h3></a></li>
			<i class="fa fa-star-o"></i>
			{$cf = $cf + 1}
		{/if}
				
		{if $config.show_topseller eq '1'}
			<li class="nav-item"><a class="{if $cf eq 0}active{/if} button" data-toggle="tab" href="#topseller"><h3>{l s='Best Seller' d='Shop.Theme'}</h3></a></li>
			<i class="fa fa-star-o"></i>
			{$cf = $cf + 1}
		{/if}		
		{if $config.show_special eq '1'}
			<li class="nav-item"><a class="{if $cf eq 0}active{/if} button" data-toggle="tab" href="#special"><h3>{l s='Special'  d='Shop.Theme'}</h3></a></li>
			<i class="fa fa-star-o"></i>
			{$cf = $cf + 1}
		{/if}			
		{if $config.show_onsale eq '1'}
			<li class="nav-item"><a class="{if $cf eq 0}active{/if} button" data-toggle="tab" href="#onsale"><h3>{l s='Sale Off'  d='Shop.Theme'}</h3></a></li>
			<i class="fa fa-star-o"></i>
			{$cf = $cf + 1}
		{/if}			
	</ul>
