        ...
        <div class="row">
          ...
          <div class="col-md-7  col-xs-6 divide-left">
            <div class="cart-content">
              ...
              <button type="button" class="btn-default btn-effect btn-cart" data-dismiss="modal">{l s='Continue shopping' d='Shop.Theme.Actions'}</button>
              <a href="{$cart_url}" class="btn-default btn-effect btn-cart">{l s='proceed to checkout' d='Shop.Theme.Actions'}</a>
            </div>
          </div>
        </div>
      </div>
